...
// Adapted from code found at https://github.com/StefH/Span.ReaderWriter/blob/main/src/Span.ReaderWriter/SpanReader.cs
public ref struct SpanReader
{
	...
	public SpanReader(ReadOnlySpan<byte> span) : this(span, Encoding.UTF8)
	{ }
	...
	{
		var newSpan = _currentSpan[Position..];
	...
	private const string Format_Bad7BitInt = "Too many bytes in what should have been a 7-bit encoded integer.";
